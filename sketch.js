...
trophyImg=loadImage("trophy2.png")
...
//jet.debug = true
if(jet.isTouching(edge)||jet.isTouching(obstacle1)||jet.isTouching(obstacle2)||jet.isTouching(obstacle3)||jet.isTouching(obstacle4)||jet.isTouching(trophy)||jet.isTouching(floor)||jet.isTouching(roof)){
jet.x = 80
jet.y = 350
score = 0
}
